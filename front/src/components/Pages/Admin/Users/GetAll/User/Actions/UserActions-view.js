...
const UserActionsView = ({ translations, user, deleteAction, setAdminUser }) => (
  <Grid xs={12} sm={4} item>
    <Grid container className="items-end justify-end sm:flex-col">
      ...
      <Grid xs={6} sm={9} md={7} lg={5} item className="w-full my-1 sm:my-0 px-1">
        <ActionButton.Edit onClick={() => setAdminUser(user)} component={Link} to={`/admin/users/${user._id}/edit`} className="w-full">

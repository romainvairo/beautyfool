...
const Router = () => (
  <Switch>
    ...
    <Route exact path={['/admin/actualities', '/admin/actualites']} component={AdminActualities} />
    ...
    <Route exact path={['/admin/calendar', '/admin/calendrier']} component={AdminCalendar} />
    ...
    <Route exact path={['/admin/services', '/admin/prestations']} component={AdminBenefits} />
    ...
    <Route exact path={['/admin/users', '/admin/utilisateurs']} component={AdminUsers} />
    ...
    <Route exact path={['/admin/feedbacks', '/admin/avis']} component={AdminFeedbacks} />
    ...
    <Route exact path={['/admin/comments', '/admin/commentaires']} component={AdminComments} />
    ...
    <Route exact path={['/admin/gallery', '/admin/galerie']} component={AdminGallery} />
    ...
    <Route exact path={['/admin/beauty-tips', '/admin/astuces-beaute']} component={AdminBeautyTips} />
